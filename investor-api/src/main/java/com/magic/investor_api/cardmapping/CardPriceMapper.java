package com.magic.investor_api.cardmapping;
...
public class CardPriceMapper {
    ...
    public List<CardmarketPrice> mapNodeToCardPrice(JsonNode node) {

        List<CardmarketPrice> prices = new ArrayList<>();

        CardmarketPrice newPrice = new CardmarketPrice();
